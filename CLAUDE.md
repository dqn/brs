...
- [x] **18-5. PlayState 結線** — BGAProcessor 統合 (Phase 21 で部分統合済み、ランタイム結線は未完)
...
- [x] **19-A6. JSON Play Loader 拡張** — note/bga/judge ハンドリング
...
- [x] **19-B4. JSON Select Loader 拡張** — songlist ハンドリング
...
- [x] **19-E2.** JSON スキン状態固有オブジェクト読み込みユニットテスト
