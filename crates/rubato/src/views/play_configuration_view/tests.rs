...
fn test_update_delegates_to_video_controller() {
    ...
    let config = Config {
        ...
        render: crate::core::config::RenderConfig {
            bga: crate::skin::config::BgaMode::Off,
            ..Default::default()
        },
        ..Default::default()
    };
    ...
    assert_eq!(out_config.render.bga, crate::skin::config::BgaMode::Off);
}
...
fn test_update_player_commit_player_roundtrip() {
    ...
    let player = PlayerConfig {
        ...
        judge_settings: crate::skin::player_config::JudgeSettings {
            judgetiming: 10,
            custom_judge: true,
        ...
        note_modifier_settings: crate::skin::player_config::NoteModifierSettings {
            longnote_mode: 3,
            longnote_rate: 1.5,
            ..Default::default()
        },
        misc_settings: crate::skin::player_config::MiscSettings {
