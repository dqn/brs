...
pub struct TimerManager {
    ...
    pub state_type: Option<crate::skin::main_state_type::MainStateType>,
...
impl TimerManager {
    pub fn new() -> Self {
        ...
        Self {
            ...
            start_mono_micros: crate::skin::monotonic_clock::monotonic_micros(),
            nowmicrotime: 0,
            frozen: false,
            timer,
            state_type: None,
    ...
    pub fn set_main_state(&mut self) {
        ...
        self.start_mono_micros = crate::skin::monotonic_clock::monotonic_micros();
...
impl crate::skin::timer_access::TimerAccess for TimerManager {
...
impl crate::skin::skin_render_context::SkinRenderContext for TimerManager {
