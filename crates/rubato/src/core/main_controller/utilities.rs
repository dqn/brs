...
impl MainController {
    ...
    pub fn now_time_for_id(&self, id: crate::skin::timer_id::TimerId) -> i64 {
    ...
    pub fn now_micro_time_for_id(&self, id: crate::skin::timer_id::TimerId) -> i64 {
        self.ctx.timer.now_micro_time_for_id(id)
    }

    pub fn timer_value(&self, id: crate::skin::timer_id::TimerId) -> i64 {
        self.micro_timer(id) / 1000
    }

    pub fn micro_timer(&self, id: crate::skin::timer_id::TimerId) -> i64 {
        self.ctx.timer.micro_timer(id)
    }

    pub fn is_timer_on(&self, id: crate::skin::timer_id::TimerId) -> bool {
        self.micro_timer(id) != i64::MIN
    }

    pub fn set_timer_on(&mut self, id: crate::skin::timer_id::TimerId) {
        self.ctx.timer.set_timer_on(id);
    }

    pub fn set_timer_off(&mut self, id: crate::skin::timer_id::TimerId) {
        self.set_micro_timer(id, i64::MIN);
    }

    pub fn set_micro_timer(&mut self, id: crate::skin::timer_id::TimerId, microtime: i64) {
        self.ctx.timer.set_micro_timer(id, microtime);
    }

    pub fn switch_timer(&mut self, id: crate::skin::timer_id::TimerId, on: bool) {
    ...
    pub fn loudness_analyzer(
        &self,
    ) -> Option<&crate::audio::bms_loudness_analyzer::BMSLoudnessAnalyzer> {
    ...
    /// display names via crate::skin::target_list.
    pub fn set_target_list(&mut self) {
        ...
        let rivals: Vec<crate::skin::player_information::PlayerInformation> =
        ...
        let names: Vec<String> = targetlist
            .iter()
            .map(|id| crate::skin::target_list::resolve_target_name(id, &rivals).into_owned())
            .collect();

        crate::skin::target_list::set_target_ids(targetlist);
        crate::skin::target_list::set_target_names(names);
    }
