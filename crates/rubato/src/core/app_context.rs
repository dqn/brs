...
pub struct GameContext {
    ...
    pub loudness_analyzer: Option<crate::audio::bms_loudness_analyzer::BMSLoudnessAnalyzer>,
...
impl GameContext {
    ...
    pub fn update_audio_config(&mut self, audio: crate::skin::audio_config::AudioConfig) {
    ...
    pub fn update_skin_config(
        &mut self,
        id: usize,
        skin_config: Option<crate::skin::skin_config::SkinConfig>,
    ) {
    ...
    pub fn update_skin_history(
        &mut self,
        skin_path: &str,
        skin_config: crate::skin::skin_config::SkinConfig,
    ) {
    ...
    pub fn start_ipfs_download(&self, song: &crate::skin::song_data::SongData) -> bool {
