...
use crate::skin::reexports::{MainState, SkinOffset, TextureRegion};
...
impl SkinNumber {
    ...
    pub fn new_empty() -> Self {
        use crate::skin::skin_source_image_set::SkinSourceImageSet;
        Self {
...
impl crate::skin::types::skin_node::SkinNode for SkinNumber {
...
mod tests {
    ...
    impl IntegerProperty for ConstIntProp {
        fn get(&self, _state: &dyn crate::skin::reexports::MainState) -> i32 {
            self.0
        }
    }
