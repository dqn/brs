...
use crate::skin::reexports::{BitmapFont, Color, MainState};
...
pub struct SkinNoteObject {
    ...
    pub inner: crate::skin::skin_note::SkinNote,
    ...
    pub note_images: Vec<Option<crate::skin::reexports::TextureRegion>>,
    /// Per-lane mine note textures.
    pub mine_images: Vec<Option<crate::skin::reexports::TextureRegion>>,
    /// Per-lane LN body textures (10 types).
    pub ln_body_images: Vec<[Option<crate::skin::reexports::TextureRegion>; 10]>,
    ...
    pub judge_area_image: Option<crate::skin::reexports::TextureRegion>,
...
pub struct LineImage {
    pub region: crate::skin::reexports::TextureRegion,
    pub dst_x: f32,
    pub dst_width: f32,
    pub dst_height: f32,
}
...
impl SkinNoteObject {
    pub fn new(lane_count: usize) -> Self {
        ...
        Self {
            data,
            inner: crate::skin::skin_note::SkinNote::new(lane_count),
...
impl crate::skin::types::skin_node::SkinNode for SkinNoteObject {
