...
use crate::skin::reexports::{MainState, Pixmap, PixmapFormat, Texture, TextureRegion};
use crate::skin::types::skin_object::{SkinObjectData, SkinObjectRenderer};
use crate::skin::util::parse_hex_color;
...
impl crate::skin::types::skin_node::SkinNode for SkinGaugeGraphObject {
...
mod tests {
    use super::*;
    use crate::skin::reexports::SkinOffset;
    ...
    impl MockGaugeState {
        fn new(gauge_type: i32) -> Self {
            Self {
                timer: crate::skin::reexports::Timer::default(),
                gauge_type,
                gauge_history: None,
            }
        }
    ...
    impl crate::skin::timer_access::TimerAccess for MockGaugeState {
        ...
        fn micro_timer(&self, id: crate::skin::timer_id::TimerId) -> i64 {
            self.timer.micro_timer(id)
        }
        fn timer(&self, id: crate::skin::timer_id::TimerId) -> i64 {
            self.timer.timer(id)
        }
        fn now_time_for(&self, id: crate::skin::timer_id::TimerId) -> i64 {
            self.timer.now_time_for(id)
        }
        fn is_timer_on(&self, id: crate::skin::timer_id::TimerId) -> bool {
            self.timer.is_timer_on(id)
        }
    }

    impl crate::skin::skin_render_context::SkinRenderContext for MockGaugeState {
    ...
    impl crate::skin::reexports::MainState for MockGaugeState {}
