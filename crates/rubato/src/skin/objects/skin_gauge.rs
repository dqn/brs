...
use crate::skin::reexports::{Color, MainState, TextureRegion};
use crate::skin::sources::skin_source_image_set::SkinSourceImageSet;
use crate::skin::sources::skin_source_set::SkinSourceSet;
...
impl crate::skin::types::skin_node::SkinNode for SkinGauge {
...
mod tests {
    ...
    fn draw_random_animation_full_gauge() {
        ...
        gauge.gauge_type = 0;
        gauge.animation = 1;
        gauge.data.region = crate::skin::reexports::Rectangle::new(0.0, 0.0, 100.0, 20.0);
        let mut renderer = SkinObjectRenderer::new();
        gauge.draw_impl(&mut renderer);
    }
    ...
    impl crate::skin::timer_access::TimerAccess for GaugeMockState {
    ...
    impl crate::skin::skin_render_context::SkinRenderContext for GaugeMockState {
    ...
    impl crate::skin::reexports::MainState for GaugeMockState {}
    ...
    impl crate::skin::timer_access::TimerAccess for ModeChangeMockState {
        fn now_time(&self) -> i64 {
            0
        }
        fn now_micro_time(&self) -> i64 {
    ...
    impl crate::skin::skin_render_context::SkinRenderContext for ModeChangeMockState {
        fn gauge_value(&self) -> f32 {
            self.gauge_value
        }
        fn gauge_type(&self) -> i32 {
    ...
    impl crate::skin::reexports::MainState for ModeChangeMockState {}
    ...
    impl crate::skin::timer_access::TimerAccess for ResultMockState {
        fn now_time(&self) -> i64 {
            0
        }
        fn now_micro_time(&self) -> i64 {
    ...
    impl crate::skin::skin_render_context::SkinRenderContext for ResultMockState {
        fn gauge_value(&self) -> f32 {
            self.gauge_value
        }
        fn gauge_type(&self) -> i32 {
        ...
        fn current_state_type(&self) -> Option<crate::skin::main_state_type::MainStateType> {
            Some(crate::skin::main_state_type::MainStateType::Result)
        }
    ...
    impl crate::skin::reexports::MainState for ResultMockState {}
