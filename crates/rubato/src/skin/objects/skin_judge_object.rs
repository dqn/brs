...
pub struct SkinJudgeObject {
    ...
    pub inner: crate::skin::skin_judge::SkinJudge,
...
impl SkinJudgeObject {
    pub fn new(player: i32, shift: bool) -> Self {
        ...
        Self {
            data,
            inner: crate::skin::skin_judge::SkinJudge::new(player, shift),
...
impl crate::skin::types::skin_node::SkinNode for SkinJudgeObject {
...
mod tests {
    use super::*;
    use crate::skin::objects::skin_number::NumberDisplayConfig;
    use crate::skin::reexports::{TextureRegion, Timer};
    ...
    impl crate::skin::timer_access::TimerAccess for JudgeMockState {
    ...
    impl crate::skin::skin_render_context::SkinRenderContext for JudgeMockState {
