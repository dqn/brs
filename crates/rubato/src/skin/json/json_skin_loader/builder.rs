...
use crate::skin::json::json_course_result_skin_object_loader::JsonCourseResultSkinObjectLoader;
use crate::skin::json::json_decide_skin_object_loader::JsonDecideSkinObjectLoader;
use crate::skin::json::json_key_configuration_skin_object_loader::JsonKeyConfigurationSkinObjectLoader;
use crate::skin::json::json_play_skin_object_loader::JsonPlaySkinObjectLoader;
use crate::skin::json::json_result_skin_object_loader::JsonResultSkinObjectLoader;
use crate::skin::json::json_select_skin_object_loader::JsonSelectSkinObjectLoader;
use crate::skin::json::json_skin;
use crate::skin::json::json_skin_configuration_skin_object_loader::JsonSkinConfigurationSkinObjectLoader;
use crate::skin::json::json_skin_serializer::JsonSkinSerializer;
...
impl JSONSkinLoader {
    ...
    pub fn with_config(config: &crate::skin::config::Config) -> Self {
        Self {
            dstr: Resolution {
    ...
    pub(super) fn get_skin_for_type(
        ...
        use crate::skin::json::json_skin_object_loader::JsonSkinObjectLoader;
    ...
    fn load_skin_object_for_type(
        ...
        match skin_type {
            ...
            | SkinType::Play24KeysDouble => {
                let loader_impl =
                    crate::skin::json::json_play_skin_object_loader::JsonPlaySkinObjectLoader;
                loader_impl.load_skin_object(self, skin, sk, dst, p)
            }
            // Java: MUSIC_SELECT
            SkinType::MusicSelect => {
                let loader_impl =
                    crate::skin::json::json_select_skin_object_loader::JsonSelectSkinObjectLoader;
                loader_impl.load_skin_object(self, skin, sk, dst, p)
            }
            // Java: DECIDE
            SkinType::Decide => {
                let loader_impl =
                    crate::skin::json::json_decide_skin_object_loader::JsonDecideSkinObjectLoader;
                loader_impl.load_skin_object(self, skin, sk, dst, p)
            }
            // Java: RESULT
            SkinType::Result => {
                let loader_impl =
                    crate::skin::json::json_result_skin_object_loader::JsonResultSkinObjectLoader;
                loader_impl.load_skin_object(self, skin, sk, dst, p)
            }
            // Java: COURSE_RESULT
            SkinType::CourseResult => {
                let loader_impl = crate::skin::json::json_course_result_skin_object_loader::JsonCourseResultSkinObjectLoader;
                loader_impl.load_skin_object(self, skin, sk, dst, p)
            }
            // Java: SKIN_SELECT
            SkinType::SkinSelect => {
                let loader_impl = crate::skin::json::json_skin_configuration_skin_object_loader::JsonSkinConfigurationSkinObjectLoader;
                loader_impl.load_skin_object(self, skin, sk, dst, p)
            }
            // Java: KEY_CONFIG + default
            _ => {
                let loader_impl = crate::skin::json::json_key_configuration_skin_object_loader::JsonKeyConfigurationSkinObjectLoader;
                loader_impl.load_skin_object(self, skin, sk, dst, p)
            }
        }
    }
...
const HEADER_TYPE_BEATORJASKIN: i32 = crate::skin::skin_header::TYPE_BEATORJASKIN;

const MOV_EXTENSIONS: &[&str] = &[".mpg", ".mpeg", ".avi", ".wmv", ".mp4", ".m4v", ".webm"];

pub(super) fn is_skin_customize_button(event_id: i32) -> bool {
    crate::skin::skin_property_mapper::is_skin_customize_button(event_id)
}

pub(super) fn skin_customize_index(event_id: i32) -> i32 {
    crate::skin::skin_property_mapper::skin_customize_index(event_id)
}
