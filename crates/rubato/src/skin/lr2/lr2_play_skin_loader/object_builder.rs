...
impl LR2SkinLoaderAccess for LR2PlaySkinLoaderState {
    ...
    fn assemble_objects(&mut self, skin: &mut crate::skin::skin::Skin) {
        ...
        let mut extracted_lines: [Option<crate::skin::skin_note_object::LineImage>; 8] =
            Default::default();
        for (i, line_opt) in self.line_images.iter().enumerate() {
                ...
                && let Some(region) = line_img.first_frame_region()
            {
                ...
                extracted_lines[i] = Some(crate::skin::skin_note_object::LineImage {
                    region,
                    dst_x,
                    dst_width: dst_w,
                    dst_height: dst_h,
        ...
        if self.lanerender {
            ...
            let mut note_obj = crate::skin::skin_note_object::SkinNoteObject::new(lane_count);
        ...
        if self.bga {
            let mut bga_obj = crate::skin::skin_bga_object::SkinBgaObject::new(0);
    ...
    fn apply_play_properties_to_skin(&self, skin: &mut crate::skin::skin::Skin) {
