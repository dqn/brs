...
use crate::skin::skin_object::SkinObjectData;
...
pub struct LR2PlaySkinLoaderState {
    ...
    pub skin_type: crate::skin::skin_type::SkinType,
    ...
    pub judge_objects: [Option<crate::skin::skin_judge_object::SkinJudgeObject>; 3],
...
mod tests {
    ...
    fn test_dst_bga_assembled_into_skin_object() {
        ...
        let mut skin = crate::skin::skin::Skin::new(crate::skin::skin_header::SkinHeader::new());
        use crate::skin::lr2::lr2_skin_csv_loader::LR2SkinLoaderAccess;
        state.assemble_objects(&mut skin);

        // Find the BGA object in the skin
        let bga_obj = skin.objects().iter().find(|o| {
            o.as_any()
                .downcast_ref::<crate::skin::skin_bga_object::SkinBgaObject>()
                .is_some()
        });
    ...
    fn test_src_nowjudge_creates_judge_object() {
        ...
        state.csv.imagelist.push(
            crate::skin::lr2::lr2_skin_csv_loader::ImageListEntry::TextureEntry(Texture::new(
                "test",
            )),
        );
    ...
    fn test_dst_nowjudge_adds_detail_objects() {
        ...
        if added == 4 {
            ...
            assert!(
                objs[len - 2]
                    .as_any()
                    .downcast_ref::<crate::skin::skin_number::SkinNumber>()
                    .is_some()
            );
            assert!(
                objs[len - 1]
    ...
    fn test_dst_nowjudge_detail_objects_are_images() {
        ...
        assert!(
            objs[initial_count]
                .as_any()
                .downcast_ref::<crate::skin::skin_image::SkinImage>()
                .is_some(),
