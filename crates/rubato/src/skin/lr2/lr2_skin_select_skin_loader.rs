...
impl LR2SkinSelectSkinLoaderState {
    ...
    pub fn count_custom_properties(&mut self, skin: &crate::skin::skin::Skin) {
        use crate::skin::skin_property_mapper::{is_skin_customize_button, skin_customize_index};
...
mod tests {
    ...
    use crate::skin::skin_property::{BUTTON_SKIN_CUSTOMIZE1, BUTTON_SKIN_CUSTOMIZE10};
