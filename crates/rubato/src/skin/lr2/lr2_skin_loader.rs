...
use crate::skin::property::boolean_property_factory::BooleanPropertyFactory;
...
pub fn process_src_notechart(
    str_parts: &[String],
    gauge: &mut crate::skin::reexports::Rectangle,
    noteobj: &mut Option<crate::skin::skin_note_distribution_graph::SkinNoteDistributionGraph>,
) {
    let values = parse_int(str_parts);
    let obj = crate::skin::skin_note_distribution_graph::SkinNoteDistributionGraph::new(
        values[1], values[15], values[16], values[17], values[18], values[19],
    );
    *gauge = crate::skin::reexports::Rectangle::new(0.0, 0.0, values[11] as f32, values[12] as f32);
    *noteobj = Some(obj);
}
...
pub fn process_dst_notechart(
    ...
    if let Some(obj) = noteobj {
        let dstw = crate::skin::safe_div_f32(dst_width, src_width);
        let dsth = crate::skin::safe_div_f32(dst_height, src_height);
...
pub fn process_src_bpmchart(
    str_parts: &[String],
    gauge: &mut crate::skin::reexports::Rectangle,
    bpmgraphobj: &mut Option<crate::skin::skin_bpm_graph::SkinBPMGraph>,
) {
    let values = parse_int(str_parts);
    let obj = crate::skin::skin_bpm_graph::SkinBPMGraph::new(
        crate::skin::skin_bpm_graph::BpmGraphConfig {
            delay: values[3],
            line_width: values[4],
    ...
    *gauge = crate::skin::reexports::Rectangle::new(0.0, 0.0, values[1] as f32, values[2] as f32);
...
mod tests {
    ...
    fn process_dst_notechart_y_matches_java() {
        ...
        let mut gauge = crate::skin::reexports::Rectangle::new(0.0, 0.0, gauge_w, gauge_h);
        let mut noteobj = Some(
            crate::skin::skin_note_distribution_graph::SkinNoteDistributionGraph::new_default(),
        );
    ...
    fn process_dst_bpmchart_y_matches_java() {
        ...
        let str_parts = make_dst_str_parts(50, 200);
        let mut gauge = crate::skin::reexports::Rectangle::new(0.0, 0.0, gauge_w, gauge_h);
        let mut bpmobj = Some(crate::skin::skin_bpm_graph::SkinBPMGraph::new(
            crate::skin::skin_bpm_graph::BpmGraphConfig {
                delay: 0,
                line_width: 1,
                main_bpm_color: "",
