...
use crate::skin::lr2::lr2_font_loader::LR2FontLoader;
use crate::skin::lr2::lr2_skin_loader::{self, LR2SkinLoaderState};
use crate::skin::objects::skin_number::{NumberDisplayConfig, SkinNumber};
use crate::skin::objects::skin_slider::SkinSlider;
use crate::skin::reexports::{MainState, Resolution, Texture, TextureRegion};
use crate::skin::safe_div_f32;
use crate::skin::skin_gauge::SkinGauge;
use crate::skin::skin_image::SkinImage;
use crate::skin::skin_object::DestinationParams;
use crate::skin::skin_text_font::SkinTextFont;
use crate::skin::skin_text_image::{SkinTextImage, SkinTextImageSource};
...
impl LR2SkinCSVLoaderState {
                ...
                if gr >= 100 {
                    ...
                    if gr_usize < self.imagelist.len() {
                        if let ImageListEntry::Movie(ref movie_path) = self.imagelist[gr_usize] {
                            ...
                            let movie =
                                crate::skin::skin_source_movie::SkinSourceMovie::new(movie_path);
            ...
            "SRC_TEXT" => {
                    ...
                    && self.fontlist[font_index].is_some()
                {
                    ...
                    t.text_data.ref_prop =
                        crate::skin::property::string_property_factory::string_property_by_id(
                            values[3],
                        );
                    t.text_data.align = values[4];
                    t.text_data.editable = values[5] != 0;
    ...
    pub fn apply_to_skin(&self, skin: &mut crate::skin::skin::Skin) {
