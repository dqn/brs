...
pub trait LR2SkinLoaderAccess {
    ...
    fn apply_play_properties_to_skin(&self, _skin: &mut crate::skin::skin::Skin) {
...
fn create_lr2_loader(
    ...
    match skin_type {
        SkinType::MusicSelect => Some(Box::new(
            crate::skin::lr2::lr2_select_skin_loader::LR2SelectSkinLoaderState::new(
                src, dst, usecim, skinpath,
            ),
        )),
        SkinType::Decide => Some(Box::new(
            crate::skin::lr2::lr2_decide_skin_loader::LR2DecideSkinLoaderState::new(
                src, dst, usecim, skinpath,
            ),
        )),
        SkinType::Result => Some(Box::new(
            crate::skin::lr2::lr2_result_skin_loader::LR2ResultSkinLoaderState::new(
                src, dst, usecim, skinpath,
            ),
        )),
        SkinType::CourseResult => Some(Box::new(
            crate::skin::lr2::lr2_course_result_skin_loader::LR2CourseResultSkinLoaderState::new(
                src, dst, usecim, skinpath,
            ),
        )),
        SkinType::SkinSelect => Some(Box::new(
            crate::skin::lr2::lr2_skin_select_skin_loader::LR2SkinSelectSkinLoaderState::new(
                src, dst, usecim, skinpath,
            ),
        )),
        st if st.is_play() => Some(Box::new(
            crate::skin::lr2::lr2_play_skin_loader::LR2PlaySkinLoaderState::new(
...
pub fn load_lr2_skin(
    ...
    // 1. Load header
    let mut header_loader =
        crate::skin::lr2::lr2_skin_header_loader::LR2SkinHeaderLoader::new(&skinpath);
