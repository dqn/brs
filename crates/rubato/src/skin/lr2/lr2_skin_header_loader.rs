...
use crate::skin::offset_capabilities::OffsetCapabilities;

use crate::skin::lr2::lr2_skin_loader::LR2SkinLoaderState;
use crate::skin::reexports::{MainState, Resolution};
use crate::skin::skin_property::{
    OFFSET_ALL, OFFSET_JUDGE_1P, OFFSET_JUDGEDETAIL_1P, OFFSET_NOTES_1P,
};
...
pub struct LR2SkinHeaderData {
    ...
    pub skin_type: Option<crate::skin::skin_type::SkinType>,
    pub name: String,
    pub author: String,
                ...
                if str_parts.len() >= 4 {
                    if let Ok(type_id) = str_parts[1].trim().parse::<i32>() {
                        self.header.skin_type =
                            crate::skin::skin_type::SkinType::skin_type_by_id(type_id);
                    }
