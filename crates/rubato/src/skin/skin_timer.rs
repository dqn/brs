...
impl Timer {
    ...
    pub fn micro_timer(&self, timer_id: crate::skin::timer_id::TimerId) -> i64 {
    ...
    pub fn timer(&self, timer_id: crate::skin::timer_id::TimerId) -> i64 {
        self.micro_timer(timer_id) / 1000
    }

    pub fn now_time_for(&self, timer_id: crate::skin::timer_id::TimerId) -> i64 {
    ...
    pub fn is_timer_on(&self, timer_id: crate::skin::timer_id::TimerId) -> bool {
        self.micro_timer(timer_id) != i64::MIN
    }
}

impl crate::skin::skin_render_context::SkinRenderContext for Timer {}

impl crate::skin::timer_access::TimerAccess for Timer {
