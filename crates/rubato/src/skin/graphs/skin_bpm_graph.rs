...
impl crate::skin::types::skin_node::SkinNode for SkinBPMGraph {
...
mod tests {
    use super::*;
    use crate::skin::reexports::{Rectangle, SkinOffset, SongInformation, Timer};
    ...
    impl crate::skin::timer_access::TimerAccess for MockBpmState {
    ...
    impl crate::skin::skin_render_context::SkinRenderContext for MockBpmState {
