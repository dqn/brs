...
use crate::skin::song_data::ChartInfo;
...
pub trait SkinRenderContext: TimerAccess {
    ...
    fn set_timer_micro(&mut self, _timer_id: crate::skin::timer_id::TimerId, _micro_time: i64) {
        // default no-op
    }
    ...
    fn default_image_index_value(&self, id: i32) -> i32 {
        ...
        match id {
            ...
            89 => self.song_data_ref().map_or(-1, |song| {
                ...
                if favorite & crate::skin::song_data::INVISIBLE_SONG != 0 {
                    2
                } else if favorite & crate::skin::song_data::FAVORITE_SONG != 0 {
                    1
                } else {
                    0
                }
            ...
            90 => self.song_data_ref().map_or(-1, |song| {
                let favorite = song.favorite;
                if favorite & crate::skin::song_data::INVISIBLE_CHART != 0 {
                    2
                } else if favorite & crate::skin::song_data::FAVORITE_CHART != 0 {
                    1
                } else {
                    0
                }
    ...
    fn get_offset_value(&self, _id: i32) -> Option<&crate::skin::skin_offset::SkinOffset> {
        None
    }
...
mod tests {
    ...
    fn default_image_index_400_returns_constant_flag() {
        ...
        static PLAY_CONFIG_ENABLED: OnceLock<crate::skin::play_config::PlayConfig> =
            OnceLock::new();
        static PLAY_CONFIG_DISABLED: OnceLock<crate::skin::play_config::PlayConfig> =
            OnceLock::new();

        struct ConstantTestContext {
            config: &'static crate::skin::play_config::PlayConfig,
        }
        ...
        let enabled = PLAY_CONFIG_ENABLED.get_or_init(|| crate::skin::play_config::PlayConfig {
            enable_constant: true,
            ..crate::skin::play_config::PlayConfig::default()
        });
        let disabled = PLAY_CONFIG_DISABLED.get_or_init(|| crate::skin::play_config::PlayConfig {
    ...
    fn lnmode_from_chart_longnote_returns_0() {
        use crate::skin::song_data::{ChartInfo, FEATURE_LONGNOTE};
        let chart = ChartInfo {
    ...
    fn lnmode_from_chart_chargenote_returns_1() {
        use crate::skin::song_data::{ChartInfo, FEATURE_CHARGENOTE};
        let chart = ChartInfo {
    ...
    fn lnmode_from_chart_hellchargenote_returns_2() {
        use crate::skin::song_data::{ChartInfo, FEATURE_HELLCHARGENOTE};
        let chart = ChartInfo {
    ...
    fn lnmode_from_chart_undefined_ln_returns_none() {
        use crate::skin::song_data::{ChartInfo, FEATURE_UNDEFINEDLN};
        let chart = ChartInfo {
    ...
    fn lnmode_from_chart_longnote_plus_undefined_returns_none() {
        use crate::skin::song_data::{ChartInfo, FEATURE_LONGNOTE, FEATURE_UNDEFINEDLN};
    ...
    fn lnmode_from_chart_longnote_plus_chargenote_returns_0() {
        use crate::skin::song_data::{ChartInfo, FEATURE_CHARGENOTE, FEATURE_LONGNOTE};
