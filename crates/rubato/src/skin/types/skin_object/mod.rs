...
use crate::skin::core::stretch_type::StretchType;
...
use crate::skin::reexports::{Color, MainState, Rectangle, SkinOffset, TextureRegion};
...
pub struct RateProperty {
    ref_prop: Option<Box<dyn crate::skin::property::integer_property::IntegerProperty>>,
    min: i32,
    max: i32,
}
