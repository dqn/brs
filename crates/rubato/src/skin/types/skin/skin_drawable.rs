...
struct TimerOnlyMainState<'a> {
    timer: Option<&'a dyn crate::skin::timer_access::TimerAccess>,
    ctx: Option<&'a mut dyn crate::skin::skin_render_context::SkinRenderContext>,
    state_type: Option<crate::skin::main_state_type::MainStateType>,
    image_registry: &'a HashMap<i32, TextureRegion>,
}

impl<'a> TimerOnlyMainState<'a> {
    fn from_timer(
        timer: &'a dyn crate::skin::timer_access::TimerAccess,
        state_type: Option<crate::skin::main_state_type::MainStateType>,
    ) -> Self {
    ...
    fn from_render_context_with_images(
        ctx: &'a mut dyn crate::skin::skin_render_context::SkinRenderContext,
        image_registry: &'a HashMap<i32, TextureRegion>,
    ) -> Self {
...
impl crate::skin::timer_access::TimerAccess for TimerOnlyMainState<'_> {
...
impl crate::skin::skin_render_context::SkinRenderContext for TimerOnlyMainState<'_> {
    ...
    fn is_music_selector(&self) -> bool {
        self.ctx
            .as_deref()
            .is_some_and(crate::skin::skin_render_context::SkinRenderContext::is_music_selector)
            || self.state_type == Some(crate::skin::main_state_type::MainStateType::MusicSelect)
    }

    fn is_result_state(&self) -> bool {
        self.ctx
            .as_deref()
            .is_some_and(crate::skin::skin_render_context::SkinRenderContext::is_result_state)
            || matches!(
                self.state_type,
                Some(
                    crate::skin::main_state_type::MainStateType::Result
                        | crate::skin::main_state_type::MainStateType::CourseResult
                )
            )
    }

    fn is_bms_player(&self) -> bool {
        self.state_type == Some(crate::skin::main_state_type::MainStateType::Play)
    }
    ...
    fn player_config_ref(&self) -> Option<&crate::skin::player_config::PlayerConfig> {
        self.ctx
            .as_deref()
            .and_then(crate::skin::skin_render_context::SkinRenderContext::player_config_ref)
    }

    fn config_ref(&self) -> Option<&crate::skin::config::Config> {
        self.ctx
            .as_deref()
            .and_then(crate::skin::skin_render_context::SkinRenderContext::config_ref)
    }

    fn player_config_mut(&mut self) -> Option<&mut crate::skin::player_config::PlayerConfig> {
        self.ctx
            .as_deref_mut()
            .and_then(crate::skin::skin_render_context::SkinRenderContext::player_config_mut)
    }

    fn config_mut(&mut self) -> Option<&mut crate::skin::config::Config> {
        self.ctx
            .as_deref_mut()
            .and_then(crate::skin::skin_render_context::SkinRenderContext::config_mut)
    }

    fn selected_play_config_mut(
        &mut self,
    ) -> Option<&mut crate::skin::play_config::PlayConfig> {
        self.ctx.as_deref_mut().and_then(
            crate::skin::skin_render_context::SkinRenderContext::selected_play_config_mut,
        )
    }
    ...
    fn change_state(&mut self, state_type: crate::skin::main_state_type::MainStateType) {
        if let Some(ctx) = self.ctx.as_deref_mut() {
    ...
    fn score_data_property(&self) -> &crate::skin::score_data_property::ScoreDataProperty {
        static DEFAULT: std::sync::OnceLock<crate::skin::score_data_property::ScoreDataProperty> =
            std::sync::OnceLock::new();
        self.ctx
            .as_deref()
            .map(|c| c.score_data_property())
            .unwrap_or_else(|| {
                DEFAULT.get_or_init(crate::skin::score_data_property::ScoreDataProperty::default)
            })
    }
    ...
    fn get_offset_value(
        &self,
        id: i32,
    ) -> Option<&crate::skin::skin_offset::SkinOffset> {
        self.ctx.as_deref().and_then(|c| c.get_offset_value(id))
    }

    fn get_distribution_data(
        &self,
    ) -> Option<crate::skin::distribution_data::DistributionData> {
...
impl crate::skin::reexports::MainState for TimerOnlyMainState<'_> {
    fn skin_image(&self, id: i32) -> Option<crate::skin::render_reexports::TextureRegion> {
        self.image_registry.get(&id).cloned()
    }

    fn select_song(&mut self, mode: crate::skin::bms_player_mode::BMSPlayerMode) {
        let Some(ctx) = self.ctx.as_deref_mut() else {
            return;
        };
        let event_id = match mode.mode {
            crate::skin::bms_player_mode::Mode::Play => 15,
            crate::skin::bms_player_mode::Mode::Autoplay => 16,
            crate::skin::bms_player_mode::Mode::Practice => 315,
            crate::skin::bms_player_mode::Mode::Replay => return,
        };
        ctx.select_song_mode(event_id);
    }
}
...
impl crate::skin::skin_drawable::SkinDrawable for Skin {
    fn prepare_skin(&mut self, state_type: Option<crate::skin::main_state_type::MainStateType>) {
        let null_timer = crate::skin::timer_access::NullTimer;
    ...
    fn skin_offsets(&self) -> std::collections::HashMap<i32, crate::skin::skin_offset::SkinOffset> {
        self.offset
            .iter()
            .map(|(&id, cfg)| {
                (
    ...
    fn swap_sprite_batch(&mut self, batch: &mut crate::render::sprite_batch::SpriteBatch) {
    ...
    fn offset_entries(&self) -> Vec<(i32, crate::skin::skin_offset::SkinOffset)> {
        self.offset
            .iter()
            .map(|(&id, cfg)| {
                (
    ...
    fn compute_note_draw_commands(
        ...
        use crate::skin::objects::skin_note_object::SkinNoteObject;
    ...
    fn play_skin_properties(&self) -> crate::skin::skin_drawable::PlaySkinProperties {
        crate::skin::skin_drawable::PlaySkinProperties {
...
mod skin_drawable_delegation_tests {
    ...
    struct FullMockContext {
        score: crate::skin::score_data::ScoreData,
        replay: crate::skin::replay_data::ReplayData,
        song: crate::skin::song_data::SongData,
        play_config: crate::skin::play_config::PlayConfig,
        timing_dist: crate::skin::timing_distribution::TimingDistribution,
        score_prop: crate::skin::score_data_property::ScoreDataProperty,
    ...
    impl FullMockContext {
        fn new() -> Self {
            let mut score = crate::skin::score_data::ScoreData::default();
            score.clear = 7;

            Self {
                score,
                replay: crate::skin::replay_data::ReplayData::default(),
                song: crate::skin::song_data::SongData::default(),
                play_config: crate::skin::play_config::PlayConfig::default(),
                timing_dist: crate::skin::timing_distribution::TimingDistribution::default(),
                score_prop: crate::skin::score_data_property::ScoreDataProperty::default(),
    ...
    impl SkinRenderContext for FullMockContext {
        ...
        fn get_distribution_data(
            ...
            Some(crate::skin::distribution_data::DistributionData::default())
        }
    ...
    fn test_timer_only_mode_returns_defaults_for_all_methods() {
        let timer = crate::skin::timer_access::NullTimer;
    ...
    fn test_register_image_via_skin_drawable_populates_registry() {
        use crate::skin::skin_property::{IMAGE_BACKBMP, IMAGE_BANNER, IMAGE_STAGEFILE};
        use crate::skin::types::skin_header::SkinHeader;
        use crate::skin::skin_drawable::SkinDrawable;
    ...
    fn test_registered_images_resolve_through_timer_only_main_state() {
        ...
        use crate::skin::skin_property::IMAGE_STAGEFILE;
        use crate::render::pixmap::{Pixmap, PixmapFormat};
        use crate::render::texture::{Texture, TextureRegion};
