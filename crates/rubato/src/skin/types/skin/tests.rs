...
struct RecordingSkinRenderContext {
    timer: crate::skin::reexports::Timer,
...
impl RecordingSkinRenderContext {
    fn new(state_type: MainStateType) -> Self {
        Self {
            timer: crate::skin::reexports::Timer::with_timers(100, 100_000, Vec::new()),
            state_type,
...
fn test_timer_only_main_state_returns_expected_values() {
    let timer = crate::skin::reexports::Timer::with_timers(1000, 1_000_000, Vec::new());
...
fn test_offset_value_delegates_through_timer_only_adapter() {
    ...
    impl crate::skin::timer_access::TimerAccess for OffsetContext {
        fn now_time(&self) -> i64 {
            0
        }
        fn now_micro_time(&self) -> i64 {
        ...
        fn micro_timer(&self, _: crate::skin::timer_id::TimerId) -> i64 {
            0
        }
        fn timer(&self, _: crate::skin::timer_id::TimerId) -> i64 {
            0
        }
        fn now_time_for(&self, _: crate::skin::timer_id::TimerId) -> i64 {
            0
        }
        fn is_timer_on(&self, _: crate::skin::timer_id::TimerId) -> bool {
            false
        }
    }
    impl crate::skin::skin_render_context::SkinRenderContext for OffsetContext {
...
fn test_draw_all_objects_timed_empty_skin() {
    let mut skin = make_test_skin();
    let mut null_timer = crate::skin::timer_access::NullTimer;
...
fn test_update_custom_objects_timed_empty_skin() {
    let mut skin = make_test_skin();
    let mut timer = crate::skin::reexports::Timer::with_timers(100, 100_000, Vec::new());
...
fn test_mouse_pressed_at_empty_skin() {
    let mut skin = make_test_skin();
    let mut timer = crate::skin::timer_access::NullTimer;
    // Should not panic with no objects
...
fn test_timer_only_main_state_delegates_mutating_context_methods() {
    ...
    adapter.set_timer_micro(crate::skin::timer_id::TimerId::new(9), 12_345);
...
fn make_play_skin(skin_type: crate::skin::skin_type::SkinType) -> Skin {
...
fn test_offset_all_returns_none_for_non_play_skin() {
    let mut skin = make_play_skin(crate::skin::skin_type::SkinType::MusicSelect);
    skin.offset.insert(
        crate::skin::skin_property::OFFSET_ALL,
        crate::skin::skin_config_offset::SkinConfigOffset {
...
fn test_offset_all_returns_none_for_battle_skin() {
    let mut skin = make_play_skin(crate::skin::skin_type::SkinType::Play7KeysBattle);
    skin.offset.insert(
        crate::skin::skin_property::OFFSET_ALL,
        crate::skin::skin_config_offset::SkinConfigOffset {
            name: "All offset(%)".to_string(),
...
fn test_offset_all_works_for_all_non_battle_play_types() {
    let play_types = [
        crate::skin::skin_type::SkinType::Play5Keys,
        crate::skin::skin_type::SkinType::Play7Keys,
        crate::skin::skin_type::SkinType::Play9Keys,
        crate::skin::skin_type::SkinType::Play10Keys,
        crate::skin::skin_type::SkinType::Play14Keys,
        crate::skin::skin_type::SkinType::Play24Keys,
        crate::skin::skin_type::SkinType::Play24KeysDouble,
    ];
...
fn test_offset_all_returns_none_when_offset_not_registered() {
    ...
    let skin = make_play_skin(crate::skin::skin_type::SkinType::Play7Keys);
    assert!(
        skin.offset_all().is_none(),
...
fn test_skin_object_enum_two_phase_image() {
    ...
    let mut image = crate::skin::skin_image::SkinImage::new_with_single(make_region(32, 32));
...
fn test_skin_object_enum_two_phase_bar() {
    ...
    let mut bar_obj = crate::skin::skin_bar_object::SkinBarObject::new(0);
...
fn test_skin_object_enum_two_phase_number() {
    ...
    let mut num = crate::skin::skin_number::SkinNumber::new_with_int_timer(
        digits,
        None,
        0,
        0,
        crate::skin::skin_number::NumberDisplayConfig {
            keta: 3,
            zeropadding: 1,
            space: 0,
            align: 0,
...
fn test_skin_object_enum_two_phase_graph() {
    ...
    let mut graph = crate::skin::skin_graph::SkinGraph::new_with_int_timer(images, 0, 0, 0, 0);
...
fn test_skin_object_enum_two_phase_slider() {
    ...
    let mut slider =
        crate::skin::skin_slider::SkinSlider::new_with_int_timer(images, 0, 0, 0, 100, 0, false);
...
fn test_skin_float_in_enum_data_access() {
    ...
    let sf = crate::skin::skin_float::SkinFloat::new_with_int_timer_int_id(
        vec![vec![None; 12]],
        0,
        0,
        crate::skin::skin_float::FloatDisplayConfig {
            iketa: 3,
            fketa: 2,
...
fn test_skin_object_enum_two_phase_note() {
    let note_obj = crate::skin::skin_note_object::SkinNoteObject::new(7);
...
fn test_draw_all_objects_includes_note_object() {
    use crate::skin::draw_command::{DrawCommand, NoteImageType};

    let mut skin = make_test_skin();

    // Create a note object with a draw command and a wired texture
    let mut note_obj = crate::skin::skin_note_object::SkinNoteObject::new(7);
...
fn test_prepare_prunes_static_true_draw_conditions() {
    use crate::skin::skin_bar_object::SkinBarObject;
