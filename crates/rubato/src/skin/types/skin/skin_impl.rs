...
pub struct Skin {
    ...
    pub select_bar_data: Option<crate::skin::select_bar_data::SelectBarData>,
    ...
    pub search_text_region: Option<crate::skin::reexports::Rectangle>,
...
impl Skin {
    pub fn new(header: SkinHeader) -> Self {
        ...
        let dw = crate::skin::safe_div_f32(dst.width, org.width);
        let dh = crate::skin::safe_div_f32(dst.height, org.height);
    ...
    pub fn take_select_bar_data(&mut self) -> Option<crate::skin::select_bar_data::SelectBarData> {
    ...
    pub fn take_search_text_region(&mut self) -> Option<crate::skin::reexports::Rectangle> {
    ...
    fn create_system_image_registry() -> HashMap<i32, TextureRegion> {
        use crate::skin::render_reexports::{Pixmap, PixmapFormat, Texture};
        use crate::skin::skin_property::{IMAGE_BLACK, IMAGE_WHITE};
    ...
    pub fn draw_all_objects(&mut self, state: &dyn MainState) {
        ...
        let transform = if let Some(ref oa) = offset_all {
            crate::render::color::TransformComponents {
        ...
        let mut matrix = crate::render::color::Matrix4::new();
    ...
    pub fn offset_all(&self) -> Option<SkinOffset> {
        ...
        let cfg = self.offset.get(&crate::skin::skin_property::OFFSET_ALL)?;
