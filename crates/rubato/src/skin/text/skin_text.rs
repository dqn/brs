...
use crate::skin::reexports::{Color, MainState};
...
pub enum SkinTextEnum {
    Font(crate::skin::text::skin_text_font::SkinTextFont),
    Bitmap(crate::skin::text::skin_text_bitmap::SkinTextBitmap),
    Image(crate::skin::text::skin_text_image::SkinTextImage),
}
