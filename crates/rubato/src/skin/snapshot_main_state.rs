...
use crate::skin::render_reexports::TextureRegion;
...
// ================================================================
impl crate::skin::main_state::MainState for SnapshotMainState<'_> {
...
mod tests {
    ...
    fn skin_image_returns_none_when_not_registered() {
        ...
        assert!(crate::skin::main_state::MainState::skin_image(&state, 100).is_none());
    }
    ...
    fn skin_image_returns_registered_texture() {
        ...
        let state = SnapshotMainState::new(&mut snapshot, &registry);
        let result = crate::skin::main_state::MainState::skin_image(&state, 42);
    ...
    fn select_song_queues_requests() {
        ...
        crate::skin::main_state::MainState::select_song(&mut state, BMSPlayerMode::PLAY);
        crate::skin::main_state::MainState::select_song(&mut state, BMSPlayerMode::AUTOPLAY);
    ...
    fn take_select_song_requests_clears_buffer() {
        ...
        crate::skin::main_state::MainState::select_song(&mut state, BMSPlayerMode::PRACTICE);
