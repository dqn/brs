use crate::skin::lua::skin_lua_accessor::LuaFloatProperty;
use crate::skin::property::float_property_factory::DelegateFloatProperty;
use crate::skin::reexports::MainState;
use crate::skin::types::skin_object::RateProperty;
