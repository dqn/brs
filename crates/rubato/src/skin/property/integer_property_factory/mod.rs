use crate::skin::value_id::ValueId;
...
mod tests {
    ...
    impl crate::skin::timer_access::TimerAccess for TestState {
    ...
    impl crate::skin::skin_render_context::SkinRenderContext for TestState {
