use super::*;
use crate::skin::reexports::{MainState, Timer};
...
impl crate::skin::timer_access::TimerAccess for BoolMockState {
...
impl crate::skin::skin_render_context::SkinRenderContext for BoolMockState {
