...
use crate::skin::bms_player_mode::BMSPlayerMode;
use crate::skin::event_id::EventId;
use crate::skin::judge_algorithm::DEFAULT_ALGORITHM;
...
impl Event for SortEvent {
    fn exec(&self, state: &mut dyn MainState, arg1: i32, _arg2: i32) {
        ...
        let len = crate::skin::bar_sorter::BarSorter::DEFAULT_SORTER.len() as i32;
        let Some(config) = state.player_config_mut() else {
            return;
        };
        ...
        config.select_settings.sortid = Some(
            crate::skin::bar_sorter::BarSorter::DEFAULT_SORTER[next as usize]
                .name()
                .to_string(),
        );
        state.update_bar_after_change();
...
impl Event for SongbarSortEvent {
    fn exec(&self, state: &mut dyn MainState, arg1: i32, _arg2: i32) {
        ...
        let all = &crate::skin::bar_sorter::BarSorter::ALL_SORTER;
        let len = all.len();
        let Some(config) = state.player_config_mut() else {
            return;
        };
...
pub(super) struct PlayerConfigCycleEvent {
    pub(super) event_id: EventId,
    pub(super) get: fn(&crate::skin::player_config::PlayerConfig) -> i32,
    pub(super) set: fn(&mut crate::skin::player_config::PlayerConfig, i32),
    pub(super) count: i32,
...
pub(super) struct ConfigCycleEvent {
    pub(super) event_id: EventId,
    pub(super) get: fn(&crate::skin::config::Config) -> i32,
    pub(super) set: fn(&mut crate::skin::config::Config, i32),
    pub(super) count: i32,
}
...
impl Event for NotesDisplayTimingEvent {
    fn exec(&self, state: &mut dyn MainState, arg1: i32, _arg2: i32) {
        ...
        let max = crate::skin::player_config::JUDGETIMING_MAX;
        let min = crate::skin::player_config::JUDGETIMING_MIN;
        let inc = if arg1 >= 0 {
...
impl Event for TargetEvent {
    fn exec(&self, state: &mut dyn MainState, arg1: i32, _arg2: i32) {
        ...
        let targets = {
            let targets = crate::skin::target_list::targets();
            if targets.is_empty() {
