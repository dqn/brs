...
struct SkinIntegerPropertyAdapter(
    Box<dyn crate::skin::property::integer_property::IntegerProperty>,
);
...
struct SkinBooleanPropertyAdapter(
    Box<dyn crate::skin::property::boolean_property::BooleanProperty>,
);
...
struct SkinStringPropertyAdapter(Box<dyn crate::skin::property::string_property::StringProperty>);
...
impl IntegerPropertyFactory {
    pub fn integer_property(id: i32) -> Box<dyn IntegerProperty> {
        match crate::skin::property::integer_property_factory::integer_property_by_id(id) {
...
impl BooleanPropertyFactory {
    pub fn boolean_property(id: i32) -> Box<dyn BooleanProperty> {
        match crate::skin::property::boolean_property_factory::boolean_property(id) {
...
impl StringPropertyFactory {
    pub fn string_property(id: i32) -> Box<dyn StringProperty> {
        match crate::skin::property::string_property_factory::string_property_by_id(id) {
