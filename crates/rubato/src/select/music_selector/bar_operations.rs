...
impl MusicSelector {
    ...
    pub fn read_chart(
        ...
        let load_success = crate::skin::player_resource_access::SessionMutation::set_bms_file(
    ...
    fn compute_chart_option(
        ...
        match mode {
            ...
            ChartReplicationMode::RivalChart => rival_score.map(|rival| {
                let mut opt = crate::skin::replay_data::ReplayData::new();
        ...
        if self.panelstate != panelstate {
            if self.panelstate != 0 {
                self.main_state_data
                    .timer
                    .set_timer_on(crate::skin::timer_id::TimerId::new(
                        skin_property::TIMER_PANEL1_OFF.as_i32() + self.panelstate - 1,
                    ));
                self.main_state_data
                    .timer
                    .set_timer_off(crate::skin::timer_id::TimerId::new(
