...
use crate::audio::bms_renderer::BMSRenderer;
...
impl BMSLoudnessAnalyzer {
    ...
    fn analyze_loudness(result: &crate::audio::bms_renderer::RenderResult) -> anyhow::Result<f64> {
...
mod tests {
    ...
    fn analyze_loudness_sine_wave() {
        ...
        let render_result = crate::audio::bms_renderer::RenderResult {
            pcm_data,
