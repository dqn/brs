...
impl BMSRenderer {
    ...
    fn mix_short_pcm(
        &self,
        pcm: &crate::audio::short_pcm::ShortPCM,
        start_sample: i64,
        mix_buffer: &mut [f32],
    ) {
    ...
    fn mix_float_pcm(
        &self,
        pcm: &crate::audio::float_pcm::FloatPCM,
        start_sample: i64,
        mix_buffer: &mut [f32],
    ) {
        let samples = &pcm.sample;
    ...
    fn mix_byte_pcm(
        &self,
        pcm: &crate::audio::byte_pcm::BytePCM,
        start_sample: i64,
        mix_buffer: &mut [f32],
    ) {
        let samples = &pcm.sample;
...
mod tests {
    ...
    fn mix_short_pcm_basic() {
        use crate::audio::short_pcm::ShortPCM;
        use std::sync::Arc;
    ...
    fn mix_float_pcm_basic() {
        use crate::audio::float_pcm::FloatPCM;
        use std::sync::Arc;
    ...
    fn mix_byte_pcm_basic() {
        use crate::audio::byte_pcm::BytePCM;
        use std::sync::Arc;
