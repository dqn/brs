...
use crate::model::bms_model::LNTYPE_LONGNOTE;
use crate::model::bmson_decoder::BMSONDecoder;
use crate::model::chart_information::ChartInformation;
use crate::model::decode_log::DecodeLog;
use crate::model::osu_decoder::OSUDecoder;
...
impl ChartDecoderImpl {
    pub fn decode_path(&mut self, path: &Path) -> Option<crate::model::bms_model::BMSModel> {
    ...
    pub fn decode(&mut self, info: ChartInformation) -> Option<crate::model::bms_model::BMSModel> {
        match self {
