...
use crate::model::event_lane::EventLane;
use crate::model::judge_note::JudgeNote;
...
impl BMSModel {
    pub fn new() -> Self {
        BMSModel {
            ...
            bgamap: Vec::new(),
            base: 36,
            lnmode: crate::model::note::TYPE_UNDEFINED,
            lnobj: -1,
            from_osu: false,
            timelines: Vec::new(),
            info: None,
    ...
    pub fn total_notes(&self) -> i32 {
        crate::model::bms_model_utils::total_notes(self)
    }

    pub fn build_judge_notes(&self) -> Vec<JudgeNote> {
        crate::model::judge_note::build_judge_notes(self)
    }
        ...
        for tl in &self.timelines {
            for i in 0..keys {
                if let Some(note) = tl.note(i)
                    && note.is_long()
                    && note.long_note_type() == crate::model::note::TYPE_UNDEFINED
                {
                    return true;
                }
            }
...
mod tests {
    ...
    fn new_defaults() {
        ...
        assert_eq!(model.lnmode, crate::model::note::TYPE_UNDEFINED);
    ...
    fn contains_undefined_long_note() {
        ...
        ln.set_long_note_type(crate::model::note::TYPE_CHARGENOTE);
