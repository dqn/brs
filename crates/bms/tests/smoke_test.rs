...
use bms::table::bms_table::BmsTable;
use bms::table::bms_table_element::BmsTableElement;
use bms::table::bms_table_manager::BmsTableManager;
use bms::table::bms_table_manager_listener::BmsTableManagerListener;
...
use bms::table::event_table::EventTable;
use bms::table::event_table_element::EventTableElement;
...
fn difficulty_table_with_source_url_and_elements() {
    ...
    let mut elem = DifficultyTableElement::new_with_params(
        &bms::table::difficulty_table_element::DifficultyTableElementParams {
            did: "12",
            title: "Test Song",
            bmsid: 42,
