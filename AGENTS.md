...
- **Lifecycle:** MainController stubs: result (6 methods actively used, blocked), modmenu (type incompatibility, moderate refactoring), md-processor (dead code, deferred). PlayerResource stubs: result (blocked by mutable access + type gaps)
