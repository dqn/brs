...
| 16b | Golden Master rewrite: 28/29 pass, pending tests in `tests/pending/` | 28 |
| 16c | Integration tests: pattern pipeline(4), config round-trip(6), course data(18) | 28 |
| 17 | Independent stub resolution — verified: zero runtime `todo!()`/`unimplemented!()`, 843 tests pass | — |
